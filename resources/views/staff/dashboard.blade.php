{{-- C:\laragon\www\om_system\resources\views\staff\dashboard.blade.php --}}
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <title>Staff Dashboard | O&M HRCare</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .sidebar-menu li a { display: flex; align-items: center; gap: 12px; padding: 12px 24px; font-size: 13px; color: rgba(245,243,239,0.5); letter-spacing: 0.3px; transition: all 0.2s; position: relative; text-decoration: none; }
        ...
        .stat-info h2 { font-size: 22px; font-weight: 700; color: var(--text-main); line-height: 1.2; }
...
<div class="dashboard-layout">
    ...
    <aside class="dashboard-sidebar">
        <div class="sidebar-header">
            ...
            <div class="sidebar-role">Staff Dashboard</div>
        ...
        <nav class="sidebar-menu">
            <ul>
                ...
                <li class="{{ request()->routeIs('staff.team-staff') ? 'active' : '' }}">
                    <a href="{{ route('staff.team-staff') }}"><i class="fas fa-sitemap"></i><span>Team Staff</span></a>
                </li>
    ...
    <main class="dashboard-main">
        ...
        <div class="page-content">
            <div class="dashboard-header">
                <h2><i class="fas fa-home"></i> Staff Dashboard</h2>
                <p>Welcome back! Here's your information.</p>
            </div>
            ...
            <div class="top-stats-row">
                <div class="stat-card">
                    ...
                    <div class="stat-info"><h3>Your Role</h3><h2>{{ strtoupper(Auth::user()->role) }}</h2></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon green"><i class="fas fa-check-circle"></i></div>
                    <div class="stat-info"><h3>Status</h3><h2>{{ ucfirst(Auth::user()->status) }}</h2></div>
                </div>
                <div class="stat-card">
                    <div class="stat-icon blue"><i class="fas fa-briefcase"></i></div>
                    <div class="stat-info"><h3>Position</h3><h2 style="font-size:15px;padding-top:4px;">{{ Auth::user()->position ?? 'N/A' }}</h2></div>
                </div>
            </div>
            ...
            <div class="main-content-grid">
                ...
                <div class="calendar-container">
                    <div class="mini-calendar-header">
                        ...
                        <h4 id="calendarTitle">{{ date('F Y') }}</h4>
                ...
                <div class="right-sidebar-widgets">
                    <div class="quick-link-widget">
                        ...
                        <div class="quick-links-grid">
                            <a href="{{ route('staff.team-staff') }}" class="quick-link-btn"><i class="fas fa-sitemap"></i><span>View Team Staff</span></a>
                            <a href="{{ route('leave.index') }}" class="quick-link-btn"><i class="fas fa-umbrella-beach"></i><span>My Leave</span></a>
                            <a href="{{ route('leave.apply') }}" class="quick-link-btn"><i class="fas fa-calendar-plus"></i><span>Apply Leave</span></a>
                            <a href="{{ route('calendar.index') }}" class="quick-link-btn"><i class="fas fa-calendar-alt"></i><span>View Full Calendar</span></a>
                            <a href="{{ route('profile.edit') }}" class="quick-link-btn"><i class="fas fa-user-edit"></i><span>Edit Profile</span></a>
                            <a href="{{ route('leave.my-applications') }}" class="quick-link-btn"><i class="fas fa-list-alt"></i><span>My Applications</span></a>
                        </div>
                    </div>
...
function previousMonth() { currentMonth--; if(currentMonth<1){currentMonth=12;currentYear--;} window.location.href='{{ route('staff.dashboard') }}?year='+currentYear+'&month='+currentMonth; }
function nextMonth()     { currentMonth++; if(currentMonth>12){currentMonth=1;currentYear++;} window.location.href='{{ route('staff.dashboard') }}?year='+currentYear+'&month='+currentMonth; }
